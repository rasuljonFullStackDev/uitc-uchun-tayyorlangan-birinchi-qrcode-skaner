...
$e_sql = "SELECT * FROM `partners` WHERE id='$id_edit'";
$e_res = mysqli_query($con,$e_sql);
$row = mysqli_fetch_assoc($e_res);
$f =  $row['full_name'];
$i =  $row['Img'];
$j =  $row['job'];
$d =  $row['both_data'];
...
if(isset($_POST["hodim_kirit"])){
    ...
    if(empty($erorr)){
       if(substr($_FILES['image']["type"],0,stripos($_FILES['image']["type"],'/')) ==="image"){
        ...
        $sql = "UPDATE `partners` SET full_name='$name',job='$job',both_data='$date',telefon='$phone',img='$imgPath' WHERE id='$id_edit' ";
          ...
          <div class="tm-block-col tm-col-avatar">
            <div class="tm-bg-primary-dark tm-block tm-block-avatar">
              ...
              <div class="tm-avatar-container">
                <img src="<?php echo $i; ?>" alt="Avatar" class="tm-avatar img-fluid mb-4">
              ...
              <input type="hidden" name="image_replod" value="<?php echo $row['Img']; ?>">
            ...
            <div class="tm-bg-primary-dark tm-block tm-block-settings">
              ...
              <div class="tm-signup-form row">
                <div class="form-group col-lg-6">
                  ...
                  <input id="name" name="name" type="text" value="<?php echo $row['full_name']; ?>" class="form-control validate">
                </div>
                <div class="form-group col-lg-6">
                  <label for="email">Tug`ulgan yili</label>
                  <input id="data" name="date" type="date" value="<?php echo $row['both_data']; ?>" class="form-control validate">
                </div>
                <div class="form-group col-lg-6">
                  <label for="password">kasbi</label>
                  <input id="text" name="job" type="text" value="<?php echo $row['job']; ?>" class="form-control validate">
                </div>
                <div class="form-group col-lg-6">
                  <label for="password2">Telefon raqami</label>
                  <input id="tel" name="phone" type="tel" value="<?php echo $row['telefon']; ?>" class="form-control validate">
                </div>
